...
var DataFilter = React.createClass({
  render: function() {
    console.log("Rendering DataFilter, state=", this.state);
    return (
  ...
  componentWillReceiveProps: function(newProps) {
    if (newProps.initFilter.status === this.state.status
      ...
      console.log("DataFilter: componentWillReceiveProps, no change");
      return;
    }
    console.log("DataFilter: componentWillReceiveProps, new filter:", newProps.initFilter);
